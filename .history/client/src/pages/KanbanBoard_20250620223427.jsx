                  ...
                  <Droppable droppableId={col.id} key={col.id}>
                    {(provided, snapshot) => (
                      ...
                      >
                        ...
                        <button className="kanban-add-task-btn" onClick={() => handleQuickAdd(col.id)}>
                          + Add Task
                        </button>
                        {/* Quick Add Task Form */}
                        {addingTaskCol === col.id && (
                          <form onSubmit={handleAddTaskSubmit} style={{ marginBottom: 12 }}>
                            <input
                              type="text"
