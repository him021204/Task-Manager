                ...
                {newTasks.map((task, idx) => (
                  <div key={idx} style={{ display: 'flex', gap: 8, marginBottom: 6 }}>
                    ...
                    <select
                      ...
                      onChange={e => handleTaskInputChange(idx, 'priority', e.target.value)}
                      className="project-input"
                      style={{ flex: 1, minWidth: 90, color: getPriorityColor(task.priority) }}
                      disabled={createLoading}
                    >
                      <option value="High" style={{ color: '#ef4444' }}>High</option>
                      <option value="Medium" style={{ color: '#f59e42' }}>Medium</option>
                                  ...
                                  {task.dueDate && (
                                    <span
                                      style={{
                                        ...
                                        border: `1.5px solid ${getPriorityColor(task.priority)}`,
                                        borderRadius: 6,
                                        padding: '2px 10px',
                                        fontSize: '0.95em',
                                        background: '#f8fafc'
